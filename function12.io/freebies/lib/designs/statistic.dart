    ...
    return Container(
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            Positioned(
              // autogroupo6c5FXs (EcSEJ2t13bKKKZdULWo6c5)
              left: 0*fem,
              top: 0*fem,
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      // autogroupvfbkHUZ (EcSD3jd8jHJnKD8H2DvfbK)
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            // iconchevronleftmuX (1:522)
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 122.8*fem, 0*fem),
                            width: 8.4*fem,
                            height: 14*fem,
                            child: Image.asset(
                              'assets/designs/images/icon-chevron-left-bQH.png',
                              width: 8.4*fem,
                              height: 14*fem,
                            ),
                          ),
                    ...
                    Container(
                      // autogroup1ka5ynd (EcSDJ4YbYD8CNDiPop1KA5)
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            // iconchevrondownNNq (1:529)
                            width: 10*fem,
                            height: 6*fem,
                            child: Image.asset(
                              'assets/designs/images/icon-chevron-down-1V7.png',
                              width: 10*fem,
                              height: 6*fem,
                            ),
                          ),
            ...
            Positioned(
              // autogroup3wsmFxR (EcSDaUEvScKgFYwAg13wSM)
              left: 0*fem,
              top: 271*fem,
              child: Container(
                width: 734*fem,
            ...
            Positioned(
              // autogroupdaffvvh (EcSEomXTMQx28x6SumDaff)
              left: 0*fem,
              top: 460*fem,
              child: Container(
                                ...
                                Container(
                                  ...
                                  child: Center(
                                    ...
                                    child: SizedBox(
                                      ...
                                      height: 30*fem,
                                      child: Image.asset(
                                        'assets/designs/images/group-11-hi5.png',
                                        width: 30*fem,
                                        height: 30*fem,
                                      ),
                                    ),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            // combinedshape6YD (1:605)
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4.47*fem, 0*fem),
                            width: 16.5*fem,
                            height: 10*fem,
                            child: Image.asset(
                              'assets/designs/images/combined-shape-iN1.png',
                              width: 16.5*fem,
                              height: 10*fem,
                            ),
                          ),
                          Container(
                            // combinedshapeNkd (1:610)
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 3.95*fem, 0.5*fem),
                            width: 14.05*fem,
                            height: 10*fem,
                            child: Image.asset(
                              'assets/designs/images/combined-shape-MiD.png',
                              width: 14.05*fem,
                              height: 10*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 12*fem,
                            child: Image.asset(
                              'assets/designs/images/battery-K9F.png',
                              width: 26.5*fem,
                              height: 12*fem,
                            ),
                          ),
