...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ActivityFilter_activityAction com.example.fooderlich:activityAction}</code></td><td>Action used for activity launch.</td></tr>
     * <tr><td><code>{@link #ActivityFilter_activityName com.example.fooderlich:activityName}</code></td><td>Component name of the primary activity in the split.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:activityAction
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:activityName
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #ActivityRule_alwaysExpand com.example.fooderlich:alwaysExpand}</code></td><td>Whether the activity should always be expanded on launch.</td></tr>
     * </table>
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.fooderlich:alwaysExpand
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #Capability_queryPatterns com.example.fooderlich:queryPatterns}</code></td><td>Resource reference to the string array of query patterns for a custom capability.</td></tr>
     * <tr><td><code>{@link #Capability_shortcutMatchRequired com.example.fooderlich:shortcutMatchRequired}</code></td><td>Indicates whether a parameter in a capability template can only contain a matched
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.fooderlich:queryPatterns
     */
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.fooderlich:shortcutMatchRequired
     */
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha com.example.fooderlich:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name com.example.fooderlich:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority com.example.fooderlich:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts com.example.fooderlich:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy com.example.fooderlich:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout com.example.fooderlich:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage com.example.fooderlich:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery com.example.fooderlich:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderSystemFontFamily com.example.fooderlich:fontProviderSystemFontFamily}</code></td><td>Provides the system font family name to check before downloading the font.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.fooderlich:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name com.example.fooderlich:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name com.example.fooderlich:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:fontProviderQuery
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:fontProviderSystemFontFamily
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font com.example.fooderlich:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle com.example.fooderlich:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings com.example.fooderlich:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight com.example.fooderlich:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex com.example.fooderlich:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.fooderlich:font
     */
     ...
     * </table>
     *
     * @attr name com.example.fooderlich:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.fooderlich:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.fooderlich:ttcIndex
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPairFilter_primaryActivityName com.example.fooderlich:primaryActivityName}</code></td><td>Component name of the primary activity in the split.</td></tr>
     * <tr><td><code>{@link #SplitPairFilter_secondaryActivityAction com.example.fooderlich:secondaryActivityAction}</code></td><td>Action used for secondary activity launch.</td></tr>
     * <tr><td><code>{@link #SplitPairFilter_secondaryActivityName com.example.fooderlich:secondaryActivityName}</code></td><td>Component name of the secondary activity in the split.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:primaryActivityName
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:secondaryActivityAction
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:secondaryActivityName
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPairRule_clearTop com.example.fooderlich:clearTop}</code></td><td>If there is an existing split with the same primary container, indicates whether the
     * existing secondary container on top and all activities in it should be destroyed when a new
     * split is created using this rule.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_finishPrimaryWithSecondary com.example.fooderlich:finishPrimaryWithSecondary}</code></td><td>When all activities are finished in the secondary container, the activity in the
     * primary container that created the split should also be finished.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_finishSecondaryWithPrimary com.example.fooderlich:finishSecondaryWithPrimary}</code></td><td>When all activities are finished in the primary container, the activities in the
     * secondary container in the split should also be finished.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitLayoutDirection com.example.fooderlich:splitLayoutDirection}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitMinSmallestWidth com.example.fooderlich:splitMinSmallestWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitMinWidth com.example.fooderlich:splitMinWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitRatio com.example.fooderlich:splitRatio}</code></td><td></td></tr>
     * </table>
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.fooderlich:clearTop
     */
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.fooderlich:finishPrimaryWithSecondary
     */
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.fooderlich:finishSecondaryWithPrimary
     */
    public static final int SplitPairRule_finishSecondaryWithPrimary=2;
    /**
     * <p>This symbol is the offset where the {@link com.example.fooderlich.R.attr#splitLayoutDirection}
     ...
     * </table>
     *
     * @attr name com.example.fooderlich:splitLayoutDirection
     */
    public static final int SplitPairRule_splitLayoutDirection=3;
    /**
     * <p>This symbol is the offset where the {@link com.example.fooderlich.R.attr#splitMinSmallestWidth}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a dimension value, which is a floating point number appended with a
     * unit such as "<code>14.5sp</code>".
     ...
     * mm (millimeters).
     *
     * @attr name com.example.fooderlich:splitMinSmallestWidth
     */
    public static final int SplitPairRule_splitMinSmallestWidth=4;
    /**
     * <p>This symbol is the offset where the {@link com.example.fooderlich.R.attr#splitMinWidth}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a dimension value, which is a floating point number appended with a
     * unit such as "<code>14.5sp</code>".
     ...
     * mm (millimeters).
     *
     * @attr name com.example.fooderlich:splitMinWidth
     */
    public static final int SplitPairRule_splitMinWidth=5;
    /**
     * <p>This symbol is the offset where the {@link com.example.fooderlich.R.attr#splitRatio}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name com.example.fooderlich:splitRatio
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_placeholderActivityName com.example.fooderlich:placeholderActivityName}</code></td><td>Component name of the placeholder activity in the split.</td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitLayoutDirection com.example.fooderlich:splitLayoutDirection}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitMinSmallestWidth com.example.fooderlich:splitMinSmallestWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitMinWidth com.example.fooderlich:splitMinWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitRatio com.example.fooderlich:splitRatio}</code></td><td></td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.fooderlich:placeholderActivityName
     */
